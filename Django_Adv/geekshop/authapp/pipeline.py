...
def save_user_profile(backend, user, response, *args, **kwargs):
    ...
    api_url = f'''https://api.vk.com/method/users.get?fields=bdate,sex,about,photo_200&access_token={response["access_token"]}&v=5.131'''
    ...
    if vk_data['photo_200']:
        user.shopuserprofile.photo = vk_data['photo_200']
